    ...
    <div className="container max-w-lg mx-auto px-4 py-6">
      ...
      <div className="relative mb-4">
        ...
        <input
          ...
          className="h-11 md:h-10 w-full rounded-xl border border-gray-300 bg-white pl-10 pr-3 text-base outline-none placeholder:text-muted-foreground focus-visible:border-ring focus-visible:ring-3 focus-visible:ring-ring/50 shadow-xs"
        />
      </div>
      ...
      <div className="grid grid-cols-2 gap-3">
        ...
        {!loading &&
          filtered.map((fabric) => (
            <Link key={fabric.id} href={`/inventory/${fabric.id}`} className="h-full block active:scale-[0.98] transition-transform">
              <Card
